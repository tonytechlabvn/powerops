// Register page: full-screen centered form with dark zinc theme
// Creates account via POST /api/auth/register then auto-logs in via AuthProvider
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Org name (optional) */}
            <div>
              <label htmlFor="org-name" className="block text-sm text-zinc-400 mb-1">
                Organization name{' '}
