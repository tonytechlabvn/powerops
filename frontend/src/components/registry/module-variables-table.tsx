      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-zinc-800 bg-zinc-900/50">
            <th className="text-left px-4 py-2.5">{renderSortHeader('name', 'Name')}</th>
            <th className="text-left px-4 py-2.5">{renderSortHeader('type', 'Type')}</th>
            ...
            <th className="text-left px-4 py-2.5">{renderSortHeader('required', 'Required')}</th>
          </tr>
        </thead>
        <tbody>
          {sorted.map(v => (
